...
import { loveIcon, Chibike, arrowLeft } from "../../assets/dashboard";
        ...
        <DetailInfo>
          ...
          <Table>
            ...
            <tr>
              <td style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                <ProfileAvatar src={data?.artwork?.artist.profilePic || Chibike} alt="Profile" />
          ...
          <div>
            ...
            <BidsDiv>
              ...
              <EachBid key={item.id}>
                <ProfileAvatar src={item.user?.profilePic || Chibike} alt="Profile" />
                <div
